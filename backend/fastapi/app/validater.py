...
class validateInSafeArea:
    ...
    async def isinsafearea(self, current_loc, safe_area_list):
        distance_list = []
    ...
    async def pushNotification(self, latest_location, before_location, safeArea):
        if latest_location.isInSafeArea == 0 and before_location.isInSafeArea == 1:
            ...
            send_push_notification(Config.temp_fcm_token, "어디U", "안심 구역 진입", data)
